...
ActiveRecord::Schema.define(version: 2021_07_06_023624) do
  ...
  create_table "viewers", force: :cascade do |t|
    ...
    t.index ["viewing_party_id"], name: "index_viewers_on_viewing_party_id"
  end
  ...
  add_foreign_key "viewers", "viewing_parties"
